...
Cuenta usadas para usuarios

username   password     tipo usuario
piguino    elpinguino   cliente
juanito    armasecreta  admin
Miguelito  losbucle     profe

Integrantes
Manuel Calderón Github 
Miguel Parra Github 
Franco Arriaza Github https://github.com/francoarriaza/Evaluacion-Spring-Framework
